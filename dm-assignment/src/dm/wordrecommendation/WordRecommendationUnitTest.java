...
public class WordRecommendationUnitTest {
	...
	public void setUp() {
		 ...
		 */
		WordRecommendationMapper mapper = new WordRecommendationMapper();
		 ...
		 */
		WordRecommendationReducer reducer = new WordRecommendationReducer();
